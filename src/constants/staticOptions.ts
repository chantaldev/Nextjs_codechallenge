export const companyTypes = [
  ...
  { value: 'c-corporation', label: 'C Corporation (C Corp)' },
  { value: 's-corporation', label: 'S Corporation (S Corp)' },
  { value: 'nonprofit-organization', label: 'Nonprofit Organization' },
  { value: 'cooperative', label: 'Cooperative (Co-op)' },
  { value: 'professional-corporation', label: 'Professional Corporation (PC)' },
  { value: 'professional-limited-liability-company', label: 'Professional Limited Liability Company (PLLC)' }
];
